...
import { Agent, ClientRequest, ClientRequestArgs, IncomingMessage, OutgoingHttpHeaders, ServerResponse } from 'node:http';
...
import { CustomPluginOptions, ExistingRawSourceMap, GetManualChunk, InputOption, InputOptions, LoadResult, MinimalPluginContext, ModuleFormat, ModuleInfo, ObjectHook, OutputBundle, OutputChunk, PartialResolvedId, PluginContext, PluginHooks, ResolveIdResult, RollupError, RollupOptions, RollupOutput, RollupWatcher, SourceDescription, SourceMap, SourceMapInput, TransformPluginContext, WatcherOptions } from 'rollup';
import { HMRRuntimeConnection, ViteModuleRunner, ViteRuntime, ViteRuntimeOptions } from 'vite/runtime';
import { InferCustomEventPayload } from '../../types/customEvent.js';
import { CustomPayload, HMRPayload } from '../../types/hmrPayload.js';
import '../../types/hot.js';
...
export { build, buildErrorMessage, Connect, createFilter, createLogger, createServer, createViteRuntime, defineConfig, fetchModule, formatPostcssSourceMap, FSWatcher, HttpProxy, isCSSRequest, isFileServingAllowed, loadConfigFromFile, loadEnv, mergeAlias, mergeConfig, ModuleGraph, ModuleNode, normalizePath, optimizeDeps, PluginContainer, preprocessCSS, preview, resolveConfig, resolveEnvPrefix, rollupVersion, searchForWorkspaceRoot, send, ServerHMRConnector, sortUserPlugins, splitVendorChunk, SplitVendorChunkCache, splitVendorChunkPlugin, Terser, transformWithEsbuild, VERSION as version, WebSocket, WebSocketAlias, WebSocketServer, type Alias, type AliasOptions, type AnymatchFn, type AnymatchPattern, type AppType, type AwaitWriteFinishOptions, type BindCLIShortcutsOptions, type BuildOptions, type CLIShortcut, type CommonServerOptions, type ConfigEnv, type CorsOptions, type CorsOrigin, type CSSModulesOptions, type CSSOptions, type DepOptimizationConfig, type DepOptimizationMetadata, type DepOptimizationOptions, type ESBuildOptions, type ESBuildTransformResult, type ExperimentalOptions, type ExportsData, type FetchModuleOptions, type FileSystemServeOptions, type FilterPattern, type HMRBroadcaster, type HMRBroadcasterClient, type HMRChannel, type HmrContext, type HmrOptions, type HookHandler, type HTMLOptions, type HtmlTagDescriptor, type HttpServer, type IndexHtmlTransform, type IndexHtmlTransformContext, type IndexHtmlTransformHook, type IndexHtmlTransformResult, type InlineConfig, type InternalResolveOptions, type JsonOptions, type LegacyOptions, type LibraryFormats, type LibraryOptions, type LightningCSSOptions, type LogErrorOptions, type Logger, type LoggerOptions, type LogLevel, type LogOptions, type LogType, type MainThreadRuntimeOptions, type Manifest, type ManifestChunk, type MapToFunction, type AnymatchMatcher as Matcher, type ModulePreloadOptions, type OptimizedDepInfo, type Plugin, type PluginHookUtils, type PluginOption, type PreprocessCSSResult, type PreviewOptions, type PreviewServer, type PreviewServerHook, type ProxyOptions, type RenderBuiltAssetUrl, type ResolvedBuildOptions, type ResolvedConfig, type ResolvedCSSOptions, type ResolvedModulePreloadOptions, type ResolvedPreviewOptions, type ResolvedServerOptions, type ResolvedServerUrls, type ResolvedSSROptions, type ResolvedUrl, type ResolvedWorkerOptions, type ResolveFn, type ResolveModulePreloadDependenciesFn, type ResolveOptions, type ResolverFunction, type ResolverObject, type RollupCommonJSOptions, type RollupDynamicImportVarsOptions, type SendOptions, type ServerHMRChannel, type ServerHook, type ServerOptions, type SsrDepOptimizationOptions, type SSROptions, type SSRTarget, type TerserOptions, type TransformOptions, type TransformResult, type UserConfig, type UserConfigExport, type UserConfigFn, type UserConfigFnObject, type UserConfigFnPromise, type ViteDevServer, type WatchOptions, type WebSocketClient, type WebSocketCustomListener };
